...
import edu.ucla.cs.wis.bigdatalog.spark.storage.map.BytesToBytesMapMemoryManager;
...
/**
 * APS - this is a version of ByteToByteMap that is detached from TaskMemoryManager.
 * It will not ask for memory to be allocated and will not spill.
 *
...
public final class BytesSet {
    ...
    private final Logger logger = LoggerFactory.getLogger(BytesSet.class);
     ...
     */
    private final BytesSet.Location loc;
    ...
    public BytesSet(int initialCapacity,
                    double loadFactor,
                    long pageSizeBytes,
    ...
    public final class SetIterator implements Iterator<BytesSet.Location> {
        ...
        private SetIterator(int numRecords, BytesSet.Location loc) {
     ...
     */
    public BytesSet.SetIterator iterator() {
        return new BytesSet.SetIterator(numElements, loc);
    }
     ...
     */
    public BytesSet.Location lookup(Object keyBase, long keyOffset, int keyLength) {
    ...
    public final class Location {
        ...
        private BytesSet.Location with(int pos, int keyHashcode, boolean isDefined) {
            assert(longArray != null);
            this.pos = pos;
        ...
        private BytesSet.Location with(MemoryBlock page, long offsetInPage) {
            this.isDefined = true;
